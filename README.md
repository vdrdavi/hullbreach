...
a tela vira um voo 3D. A nave começa parada: a primeira coisa a fazer é dar a
partida e senti-la sair da inércia. Daí em diante é um caça low poly atravessando
um campo de estrelas gerado proceduralmente, desviando de asteroides — que não
vêm em chuva constante: o campo tem bolsões e veios, a viagem
alterna vazio e aperto, e as pedras derivam, então desviar é prever onde elas
vão estar. O mesmo painel também abre o
...
| Voltar ao console / fechar um painel do convés / sair | Esc | B / Back |
